...
///此控件适用于固定高度的ListView
class AdsorptionViewState<T extends AdsorptionData> extends State<AdsorptionView<T>> with AutomaticKeepAliveClientMixin{
          ...
          onTap: (){
            ...
            for(int i=a;i>=0;i--){
              if(widget.adsorptionDatas[i].isHeader) {
                widget.scrollController.animateTo(i*widget.itemHeight, duration: new Duration(milliseconds: 200), curve: Curves.linear);
                break;
              }
            }
          },
